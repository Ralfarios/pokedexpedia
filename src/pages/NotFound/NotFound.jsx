...
export const NotFound = _ => {
  ...
  return (
    <div id="NotFound" css={css`display: flex; justify-content: center; height:100vh`}>
      ...
      <div css={css`align-self: center; text-align: center;`}>
        ...
        <p style={{ textAlign: 'center', marginTop: 0 }}>A wild <b style={{color: '#275d5f'}}>Snorlax</b> has blocked your path!</p>
